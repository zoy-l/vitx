import type gulpTypescript from '@build-easy/bundles/model/gulp-typescript'
...
export default function getTSConfig(cwd: string) {
  try {
    ...
    const gulpTs = require('@build-easy/bundles/model/gulp-typescript') as typeof gulpTypescript
