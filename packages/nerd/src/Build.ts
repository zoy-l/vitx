import { transformSync as babelTransformSync } from '@nerd/bundles/@babel/core'
import sourcemaps from '@nerd/bundles/gulp-sourcemaps'
import gulpPlumber from '@nerd/bundles/gulp-plumber'
import glupTs from '@nerd/bundles/gulp-typescript'
import deepmerge from '@nerd/bundles/deepmerge'
import insert from '@nerd/bundles/gulp-insert'
import through from '@nerd/bundles/through2'
import vinylFs from '@nerd/bundles/vinyl-fs'
import gulpIf from '@nerd/bundles/gulp-if'
import less from '@nerd/bundles/gulp-less'
import rimraf from '@nerd/bundles/rimraf'
import { Diagnostic } from 'typescript'
import chalk from '@nerd/bundles/chalk'
import slash from '@nerd/bundles/slash'
