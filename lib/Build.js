...
class Build {
  ...
  createStream({
    ...
    return _vinylFs().default.src(src, {
      base: basePath,
      allowEmpty: true
    }).pipe(typeof beforeReadWriteStream === 'function' ? beforeReadWriteStream({
      ...
      insert: _gulpInsert().default,
      gulpIf: _gulpIf().default
    }) : _through().default.obj()).pipe((0, _gulpIf().default)(file => this.isTransform(/\.(t|j)sx?$/, file.path), _through().default.obj((chunk, _enc, callback) => {
      ...
      this.logInfo({
        pkg,
        msg: `➜${_chalk().default.yellow(` [${(_this$customPrefix = this.customPrefix) !== null && _this$customPrefix !== void 0 ? _this$customPrefix : esBuild ? 'esBuild' : 'babel'}]:`)} for ${_chalk().default.blue(`${output}${chunk.path.replace(basePath, '')}`)}`
      });
      ...
      if (!file.path.endsWith('.d.ts')) {
        ...
        this.logInfo({
          pkg,
          msg: `➜ ${_chalk().default.yellow(`[${(_this$customPrefix2 = this.customPrefix) !== null && _this$customPrefix2 !== void 0 ? _this$customPrefix2 : 'Copys'}]:`)} for ${_chalk().default.blue(`${output}${file.path.replace(basePath, '')}`)}`
        });
      }
      ...
      insert: _gulpInsert().default,
      gulpIf: _gulpIf().default
    }) : _through().default.obj()).pipe(_vinylFs().default.dest(_path().default.join(dir, output)));
  }
