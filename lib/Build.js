...
function babelTransformSync() {
  ...
  babelTransformSync = function babelTransformSync() {
    return data;
  };
...
class Build {
  ...
  transform(opts) {
    ...
    return (_babelTransformSync$t = babelTransformSync().transformSync(content, _objectSpread(_objectSpread({}, babelConfig), {}, {
      filename: paths,
      configFile: false
    }))) === null || _babelTransformSync$t === void 0 ? void 0 : _babelTransformSync$t.code;
  }
  ...
  createStream({
    ...
    }) : _through().default.obj()).pipe((0, _gulpIf().default)(file => tsConfig.compilerOptions.declaration && this.isTransform(/\.tsx?$/, file.path), (0, _gulpTypescript().default)(tsConfig.compilerOptions))).pipe((0, _gulpIf().default)(file => this.isTransform(/\.(t|j)sx?$/, file.path), _through().default.obj((chunk, _enc, callback) => {
